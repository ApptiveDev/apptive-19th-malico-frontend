...
const InformationInput = () => {
  ...
  return <>
    ...
    <Input placeholder='한글, 영문, 숫자 중 자유롭게 2~10자 이내' id='register-auth-name' onChange={(e) => {
    ...
    <Input placeholder='영문 소문자, 숫자 포함 6~20자 이내' id='register-auth-name' onChange={(e) => {
    ...
    <Input placeholder='영문, 숫자, 특수문자 포함 8~20자 이내' id='register-auth-name' onChange={(e) => {
      limitInputNumber(e, 20);
      if (! e.currentTarget.validity.valid) {
    ...
    <Input placeholder='비밀번호를 한 번 더 입력해주세요.' id='register-auth-name' onChange={(e) => {
      limitInputNumber(e, 20);
      if (! e.currentTarget.validity.valid) {
